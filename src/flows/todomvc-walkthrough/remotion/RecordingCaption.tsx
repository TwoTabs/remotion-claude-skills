...
// Single persistent caption — never unmounts. Looks up the active caption
// from the current frame and runs a typewriter animation on each new caption.
// Avoids the slide-up / glitch that happens when sequenced <Caption> components
// mount and unmount at every step boundary.
export const RecordingCaption: React.FC = () => {
  ...
  // ~40 chars/sec ≈ 1.33 chars/frame at 30 fps. typewriterDuration in frames.
  ...
  // Subtle fade-in at the start of each caption (no slide).
